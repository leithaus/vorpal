...
public class RSeqs extends Reg {
  ...
  public RSeqs(String p1) { string_ = p1; }

  public <R,A> R accept(com.biosimilarity.lift.model.vorpal.Absyn.Reg.Visitor<R,A> v, A arg) { return v.visit(this, arg); }

  public boolean equals(Object o) {
    if (this == o) return true;
    if (o instanceof com.biosimilarity.lift.model.vorpal.Absyn.RSeqs) {
      com.biosimilarity.lift.model.vorpal.Absyn.RSeqs x = (com.biosimilarity.lift.model.vorpal.Absyn.RSeqs)o;
